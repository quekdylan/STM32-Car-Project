// UART Command format
// Structure: <cmd>\n (simple commands) or SNAP<num>_<side>\n (image capture)
// cmd:
//  - 'A' or 'L' : Set navigation direction to LEFT (both arc and obstacle navigation)
//  - 'B' or 'R' : Set navigation direction to RIGHT (both arc and obstacle navigation)
//  - 'W' : move forward until obstacle detected (used internally, deprecated for RPi)
//  - 'S' : Trigger default routine start (from RPi)
//  - 'SNAP<num>_C' : Image capture command (e.g., SNAP1_C, SNAP2_L)
