...
/* USER CODE BEGIN EFP */
// Shared ultrasonic cache (single producer in ultrasonic_task)
extern volatile float    g_ultra_dist_cm;
extern volatile uint32_t g_ultra_age_ms;
/* USER CODE END EFP */
...
#define trigger_pin_Pin GPIO_PIN_15
