...
#define V_MAX_TICKS_PER_DT (36.0f) // Max speed during cruise phase (e.g., 30 ticks / 10ms)
...
#define YAW_KP_TICKS_PER_DEG (4.7f)  // Increased from 3.0f for better straight-line correction

// --- Turn Configuration ---
// Speed for ackermann turns (encoder ticks / 10ms per wheel after scaling).
#define TURN_BASE_TICKS_PER_DT   (18)     // base speed before inner/outer scaling
#define TURN_YAW_TARGET_DEG      (45.0f)  // default turn angle when none provided
