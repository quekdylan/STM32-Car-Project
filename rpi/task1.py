...
class TaskOne(RaspberryPi):
    ...
    def command_follower(self) -> None:
        ...
        while True:
            ...
            if command.startswith(stm32_prefixes):
                self.stm_link.send_cmd(command[0], int(command[1:]))
    ...
    def recognize_image(self, obstacle_id_with_signal: str) -> None:
        ...
        filename = f"/home/mdpgroup19/MDP/SC2079-MDP-Group-19/image_rec/results/{int(time.time())}_{obstacle_id}_{signal}.jpg"
